  ...
  return <Card>
      <CardHeader>
        <div className="flex justify-between items-center">
          <div>
            <CardTitle className="font-bold text-justify text-base">UserManagement</CardTitle>
      ...
      <CardContent>
        {isLoading ? <div className="text-center py-8">
          ...
          </div> : users && users.length > 0 ? <div className="rounded-md border">
            <Table>
              <TableHeader>
                <TableRow>
              ...
              <TableBody>
                {users.map(user => <TableRow key={user.id}>
                    ...
                    <TableCell className="text-right space-x-2">
                      ...
                      <Button variant="outline" size="sm" onClick={() => toggleActiveMutation.mutate({
                  userId: user.id,
      ...
      {editingUser && <EditUserDialog user={editingUser} open={!!editingUser} onOpenChange={open => !open && setEditingUser(null)} />}
    </Card>;
}